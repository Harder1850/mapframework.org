...
for(const phrase of ['Evidence status:','not empirical evidence','Meaningful-delta detection','False-delta rate','Appropriate escalation']) if(!delta.includes(phrase)) failures.push(`delta missing ${phrase}`);
